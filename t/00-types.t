...
language_output_is('Arc', '(set h (table)) (sref h 0 "1") (sref h 2 1) (h 1)', "2\n", 'table');
language_output_is('Arc', '(set h (table)) (sref h 0 "1") (sref h 2 1) (h "1")', "0\n", 'table');
language_output_is('Arc', '(set h (table)) (sref h 0 (list 1 2 3)) (h (list 1 2 3))', "0\n", 'table');
language_output_is('Arc', '(len (table))', "0\n", 'table');
language_output_is('Arc', '(set h (table)) (sref h 1 1) (sref h 2 1) (sref h 4 5) (len h)', "2\n", 'table');
